...
-- ============================================
-- 3. facility_tasks 테이블 (시설 업무)
-- 주의: assignee는 TEXT 타입 (assignee_id 아님)
-- ============================================
...
-- 사업장명별 조회
CREATE INDEX IF NOT EXISTS idx_facility_tasks_business_name
ON facility_tasks(business_name);
...
-- 업무 타입별 조회
CREATE INDEX IF NOT EXISTS idx_facility_tasks_type
ON facility_tasks(task_type);
...
-- 활성 상태 필터
CREATE INDEX IF NOT EXISTS idx_facility_tasks_active
ON facility_tasks(is_active, is_deleted);
