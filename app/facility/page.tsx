  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        {/* 안내 메시지 */}
        <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl shadow-sm border border-blue-200 p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="p-3 bg-blue-100 rounded-xl">
              <Building2 className="w-8 h-8 text-blue-600" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-gray-900">사업장 선택</h2>
              <p className="text-gray-600">실사를 진행할 사업장을 선택하여 시설 관리를 시작하세요</p>
            </div>
          </div>
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 text-lg transition-all"
                autoComplete="off"
              />
              {searchTerm && (
                <button
              ...
              <div className="divide-y divide-gray-100">
                {filteredList.map((business, index) => (
                  <button
                    ...
                    className={`w-full px-6 py-4 text-left transition-all group flex items-center gap-4 ${
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {!isErrorMessage(business) && (
                        <span className="text-sm text-gray-500">시설 실사 관리</span>
                      )}
                    </div>
                    {!isErrorMessage(business) && (
