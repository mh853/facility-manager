...
CREATE INDEX IF NOT EXISTS idx_government_pricing_effective ON government_pricing(effective_from);

CREATE INDEX IF NOT EXISTS idx_sales_office_settings_office ON sales_office_cost_settings(sales_office);
CREATE INDEX IF NOT EXISTS idx_sales_office_settings_active ON sales_office_cost_settings(is_active);
CREATE INDEX IF NOT EXISTS idx_sales_office_settings_effective ON sales_office_cost_settings(effective_from);

CREATE INDEX IF NOT EXISTS idx_survey_settings_type ON survey_cost_settings(survey_type);
CREATE INDEX IF NOT EXISTS idx_survey_settings_active ON survey_cost_settings(is_active);

CREATE INDEX IF NOT EXISTS idx_survey_adjustments_business ON survey_cost_adjustments(business_id);
CREATE INDEX IF NOT EXISTS idx_survey_adjustments_date ON survey_cost_adjustments(applied_date);

CREATE INDEX IF NOT EXISTS idx_revenue_business ON revenue_calculations(business_id);
CREATE INDEX IF NOT EXISTS idx_revenue_date ON revenue_calculations(calculation_date);
CREATE INDEX IF NOT EXISTS idx_revenue_sales_office ON revenue_calculations(sales_office);
CREATE INDEX IF NOT EXISTS idx_revenue_created ON revenue_calculations(created_at);

CREATE INDEX IF NOT EXISTS idx_pricing_history_table ON pricing_change_history(table_name);
CREATE INDEX IF NOT EXISTS idx_pricing_history_record ON pricing_change_history(record_id);
CREATE INDEX IF NOT EXISTS idx_pricing_history_date ON pricing_change_history(created_at);

CREATE INDEX IF NOT EXISTS idx_audit_table ON revenue_audit_log(table_name);
CREATE INDEX IF NOT EXISTS idx_audit_user ON revenue_audit_log(user_id);
CREATE INDEX IF NOT EXISTS idx_audit_date ON revenue_audit_log(created_at);
CREATE INDEX IF NOT EXISTS idx_audit_record ON revenue_audit_log(record_id);
...
COMMENT ON COLUMN government_pricing.equipment_type IS 'business_info 테이블의 컬럼명과 매핑';
COMMENT ON COLUMN government_pricing.official_price IS '환경부에서 공시한 기준 가격';
COMMENT ON COLUMN government_pricing.manufacturer_price IS '제조사에서 구매하는 실제 원가';

COMMENT ON COLUMN sales_office_cost_settings.commission_type IS 'percentage: 매출대비%, per_unit: 기기당단가';
COMMENT ON COLUMN survey_cost_settings.survey_type IS 'estimate: 견적실사, pre_construction: 착공전실사, completion: 준공실사';