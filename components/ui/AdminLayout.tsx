  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50">
      ...
      <div className="lg:flex lg:gap-6 lg:p-6 lg:h-screen">
        ...
        <div className={`
          fixed inset-y-0 left-0 z-50 w-72 bg-white lg:bg-gradient-to-br lg:from-white lg:to-gray-50 
        ...
        `}>
          <div className="flex flex-col h-full lg:p-2">
            ...
            <div className="flex items-center justify-between lg:h-20 h-16 px-6 lg:px-4 bg-gradient-to-r from-blue-600 to-indigo-700 lg:bg-gradient-to-br lg:from-blue-50 lg:via-indigo-50 lg:to-purple-50 lg:rounded-xl lg:border lg:border-blue-200 lg:mb-4">
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onClick={() => setSidebarOpen(false)}
                    className={`
                      group flex items-center px-4 py-3 lg:px-3 lg:py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                      ${isActive 
