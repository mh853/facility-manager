// app/api/air-permits/[id]/route.ts - 개별 대기필증 관리 API
...
export async function GET(
  ...
  return withApiHandler(async () => {
    ...
    try {
      ...
      console.log(`✅ [AIR-PERMIT-DETAIL] 조회 완료: ${airPermit.business_type}`);
...
export async function PUT(
  ...
  return withApiHandler(async () => {
    ...
    try {
      ...
      console.log(`✅ [AIR-PERMIT-UPDATE] 업데이트 완료: ${updatedPermit.business_type}`);
